...
const struct mp_user_filter_entry af_scaletempo2 = {
    .desc = {
        ...
        .options = (const struct m_option[]) {
            OPT_FLOAT("search-interval", wsola_search_interval_ms, M_RANGE(1, 1000)),
            OPT_FLOAT("window-size", ola_window_size_ms, M_RANGE(1, 1000)),
            OPT_FLOAT("min-speed", min_playback_rate, M_RANGE(0, FLT_MAX)),
            OPT_FLOAT("max-speed", max_playback_rate, M_RANGE(0, FLT_MAX)),
            {0}
        }
    },
