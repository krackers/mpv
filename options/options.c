...
static const m_option_t mp_vo_opt_list[] = {
    ...
    OPT_DOUBLE("initial-window-scale", initial_window_scale, CONF_RANGE, .min = 0.001, .max = 100),
    OPT_FLAG("force-window-position", force_window_position, 0),
    OPT_STRING("x11-name", winname, 0),
    OPT_FLOATRANGE("monitor-pixel-aspect", monitor_pixel_aspect, 0, 1.0/32.0, 32.0),
    OPT_FLAG("fullscreen", fullscreen, 0),
    OPT_ALIAS("fs", "fullscreen"),
    OPT_FLAG("native-keyrepeat", native_keyrepeat, 0),
    OPT_FLOATRANGE("panscan", panscan, UPDATE_VO_POS, 0.0, 1.0),
    OPT_FLOATRANGE("video-zoom", zoom, UPDATE_VO_POS, -20.0, 20.0),
    OPT_FLOATRANGE("video-pan-x", pan_x, UPDATE_VO_POS, -3.0, 3.0),
    OPT_FLOATRANGE("video-pan-y", pan_y, UPDATE_VO_POS, -3.0, 3.0),
    OPT_FLOATRANGE("video-align-x", align_x, UPDATE_VO_POS, -1.0, 1.0),
    OPT_FLOATRANGE("video-align-y", align_y, UPDATE_VO_POS, -1.0, 1.0),
    OPT_CHOICE("video-unscaled", unscaled, UPDATE_VO_POS,
    ...
    OPT_CHOICE_OR_INT("fs-screen", fsscreen_id, 0, 0, 32,
                      ({"all", -2}, {"current", -1})),
    OPT_FLAG("keepaspect", keepaspect, UPDATE_VO_POS),
...
const struct m_sub_options mp_subtitle_sub_opts = {
    .opts = (const struct m_option[]){
        ...
        OPT_FLAG("sub-scale-on-resize", sub_scale_on_resize, 0),
        OPT_CHOICE("sub-scale-to-window", sub_scale_to_window, 0, ({"default", 0}, {"force", 1})),
        OPT_CHOICE("sub-ass-scale-to-window", ass_scale_to_window, 0, ({"default", 0}, {"force", 1})),
    ...
    .defaults = &(OPT_BASE_STRUCT){
        ...
        .ass_use_margins = 0,
        .sub_use_margins = 1,
        .sub_scale_on_resize = 1,
        .ass_scale_to_window = 0,
        .sub_scale_to_window = 1,
        .teletext_page = 100,
        .sub_scale = 1,
