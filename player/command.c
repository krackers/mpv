...
static const char *const *const mp_event_property_change[] = {
    ...
    E(MPV_EVENT_VIDEO_RECONFIG, "video-out-params", "video-params",
      ...
      "width", "height", "container-fps", "aspect", "vo-configured", "current-vo",
    ...
    E(MP_EVENT_WIN_STATE, "window-minimized", "fullscreen"),
    E(MP_EVENT_DISPLAY_STATE, "display-names", "display-fps", "display-hidpi-scale"),
...
static void cmd_frame_back_step(void *p)
{
    ...
    if (cmd->cmd->repeated) {
        ...
        queue_seek(mpctx, MPSEEK_BACKSTEP, -1.0/mpctx->vo_chain->filter->container_fps,
